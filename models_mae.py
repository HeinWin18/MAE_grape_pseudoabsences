...
class MaskedAutoencoderViT(nn.Module):
    ...
    """
    def __init__(self, img_size=32, patch_size=2, in_chans=19,
    ...
    def forward(self, imgs, mask_ratio=0.75, is_testing=False, idx_masking=None, return_latent: bool = False):
        if not hasattr(self, "_printed_stats"):
            ...
            print("has NaN:", torch.isnan(imgs).any().item())
            print("has Inf:", torch.isinf(imgs).any().item())
